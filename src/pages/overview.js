        ...
        <SectionDiv>
            <Row>
                <Col sm="12" md={{ size: 10, offset: 1 }}>
                    ...
                    <hr />
                    <p>
                        blindmixer uses a <a href="https://en.wikipedia.org/wiki/Schnorr_signature">schnorr</a> <a href="https://en.wikipedia.org/wiki/Blind_signature" target="_blank" rel="noopener noreferrer">blind signatures</a>{' '}
                        ...
                        to use. And at any time they can be converted back to regular bitcoin. Using blindmixer is quite simply the cheapest and most private way to use bitcoin.
                    </p>
                    ...
                    <p>
                        A hookin (aka pegin) is the process of converting bitcoin into blindmixer coins. With a little eliptical curve magic, we can generate
                    ...
                    <p>
                        ...
                        batch transations (when appropriate). For this reason, using blindmixer as a bitcoin wallet is typically <em>signficantly</em> cheaper than using a
                        traditional wallet. 
                    </p>
