        ...
        <SectionDiv>
            <Row>
                <Col sm="12" md={{ size: 10, offset: 1 }}>
                    ...
                    <hr />
                    <p>
                        For support requests related to the wallet or its affiliated custodians, you can send an email to <a href="mailto:support@blindmixer.dev?Subject=Support%20Request">support@blindmixer.dev</a> 
                    </p>
                    <p>
